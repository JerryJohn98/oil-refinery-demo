...
from scripts.config import PathToDir, Service
from scripts.core.schemas.response_models import DefaultResponse, LoadStylesResponse
...
class DefaultHandler:
    ...
    def load_configuration():
        try:
            with open(f"{PathToDir.ASSETS}/pluginConfig.json") as file:
